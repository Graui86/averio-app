    ...
    try {
      ...
      setLeads(
        (leadsRes.data ?? []).map((item) =>
          normalizeLeadRecord(item as LeadRecord)
        )
      );
    } catch (error) {
  ...
  const saveLead = async () => {
    ...
    try {
      if (session?.user?.id) {
        ...
        if (error) throw error;
        setLeads((prev) => [normalizeLeadRecord(data as LeadRecord), ...prev]);
      } else {
      ...
      window.alert(error instanceof Error ? error.message : "Lead konnte nicht gespeichert werden.");
    }
  };
...
const printDocumentBase = ({
  ...
  const styles = {
    ...
    statCard: {
      ...
      borderRadius: "20px",
      padding: "20px",
      boxShadow: "0 18px 40px rgba(76, 91, 146, 0.08), 0 0 0 1px rgba(255,255,255,0.6) inset",
    } as const,
    statLabel: {
      margin: 0,
      color: "#5b6474",
    ...
    activeTabButton: {
      ...
      cursor: "pointer",
      fontWeight: 700,
      boxShadow: "0 14px 36px rgba(67, 56, 202, 0.24)",
    } as const,
    layoutTwoCol: {
      display: "grid",
    ...
    card: {
      ...
      borderRadius: "28px",
      padding: "28px",
      boxShadow: "0 24px 70px rgba(44, 59, 94, 0.08), 0 0 0 1px rgba(255,255,255,0.65) inset",
    } as const,
    cardTitle: {
      margin: "0 0 18px 0",
      fontSize: "22px",
    ...
    totalBox: {
      ...
      textAlign: "left" as const,
      color: "#ffffff",
      boxShadow: "0 18px 42px rgba(67, 56, 202, 0.18)",
    } as const,
    bigList: {
      display: "grid",
      gap: "18px",
    ...
    heroBox: {
      ...
      borderRadius: "24px",
      background: "radial-gradient(circle at top left, rgba(86, 64, 255, 0.26) 0%, rgba(86, 64, 255, 0) 34%), linear-gradient(135deg, #0f172a 0%, #172554 55%, #1e293b 100%)",
      color: "#ffffff",
      marginBottom: "20px",
      boxShadow: "0 22px 50px rgba(30, 41, 59, 0.18)",
    } as const,
    helperText: {
      color: "#5b6474",
      fontSize: "13px",
  ...
  const renderStatCard = (label: string, value: string | number) => (
    <div style={styles.statCard}>
      <div style={{ width: "42px", height: "4px", borderRadius: "999px", background: "linear-gradient(90deg, #38bdf8 0%, #6366f1 100%)", boxShadow: "0 8px 18px rgba(99, 102, 241, 0.18)" }} />
      <p style={{ ...styles.statLabel, marginTop: "14px" }}>{label}</p>
      ...
      <section style={styles.card}>
        ...
        <div style={{ ...styles.row, justifyContent: "space-between", alignItems: "stretch" }}>
          <div style={{ ...styles.mutedBox, flex: 1, minWidth: "320px", background: "linear-gradient(135deg, rgba(255,255,255,0.88) 0%, rgba(238,242,255,0.9) 100%)", boxShadow: "0 16px 34px rgba(79, 70, 229, 0.08)" }}>
            ...
            <div style={{ marginTop: "8px", fontSize: "22px", fontWeight: 800, letterSpacing: "-0.03em" }}>
              Voll-Backup aktiv
            </div>
  ...
  const renderOffers = () => (
    <div style={{ display: "grid", gap: "24px" }}>
      <div style={styles.contentGrid}>
        <section style={styles.card}>
          <div style={styles.heroBox}>
            <div style={{ fontSize: "12px", opacity: 0.82, marginBottom: "10px", textTransform: "uppercase", letterSpacing: "0.12em", fontWeight: 700 }}>
              Angebote & Leistungen
            </div>
            <div style={{ fontSize: "34px", fontWeight: 800, lineHeight: 1.02, letterSpacing: "-0.04em" }}>
              Angebot erstellen
            </div>
            <div style={{ marginTop: "10px", color: "rgba(255,255,255,0.78)", fontSize: "14px", lineHeight: 1.7, maxWidth: "560px" }}>
          ...
          <div style={styles.stack}>
            ...
            <div style={styles.totalBox}>
              ...
              <div style={{ fontSize: "30px", fontWeight: 800, letterSpacing: "-0.04em" }}>{formatCurrency(offerPreviewTotal)}</div>
            </div>
          </div>
        </section>
      </div>
            ...
            {finalizedOffers.map((offer) => (
              <div key={offer.id} style={styles.entityCard}>
                <div style={styles.entityHeader}>
                  <div>
                    <h3 style={{ margin: "0 0 6px 0", fontSize: "22px" }}>{offer.title}</h3>
  ...
  const renderProperties = () => (
    <div style={styles.pageStack}>
      <div style={styles.layoutTwoCol}>
        <section style={styles.card}>
          <div style={styles.heroBox}>
            <div style={{ fontSize: "12px", opacity: 0.82, marginBottom: "10px", textTransform: "uppercase", letterSpacing: "0.12em", fontWeight: 700 }}>Objekte & Betreuung</div>
            <div style={{ fontSize: "34px", fontWeight: 800, lineHeight: 1.02, letterSpacing: "-0.04em" }}>Objekt anlegen</div>
            <div style={{ marginTop: "10px", color: "rgba(255,255,255,0.78)", fontSize: "14px", lineHeight: 1.7, maxWidth: "560px" }}>Verknüpfe Kunden mit echten Objekten, hinterlege Zugangshinweise und halte Betreuungsumfang sauber strukturiert fest.</div>
          </div>
              ...
              <div style={{ ...styles.mutedBox, background: "linear-gradient(135deg, rgba(255,255,255,0.96) 0%, rgba(237, 242, 255, 0.94) 100%)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", gap: "16px", flexWrap: "wrap" }}>
                  <div>
                    ...
                    <div style={{ marginTop: "8px", fontSize: "30px", fontWeight: 800, letterSpacing: "-0.04em" }}>{selectedPropertyRecord.name}</div>
          ...
          <div style={styles.bigList}>
            {properties.map((property) => (
              <div key={property.id} style={styles.entityCard}>
                <div style={styles.entityHeader}>
                  <div>
                    <h3 style={{ margin: "0 0 6px 0", fontSize: "22px" }}>{property.name}</h3>
  ...
  const renderOperations = () => (
    <div style={styles.pageStack}>
      <section style={styles.card}>
        <div style={styles.entityHeader}>
          <div>
            ...
            <div style={styles.helperText}>Wochenansicht für geplante Einsätze, Turnover, Reinigungen und operative Aufgaben.</div>
          </div>
        ...
        <div style={styles.calendarGrid}>
          {jobsByDate.map((entry) => (
            <div key={entry.date} style={{ ...styles.calendarDayCard, borderColor: entry.date === getTodayDate() ? "rgba(129, 140, 248, 0.5)" : "rgba(255,255,255,0.08)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: "10px", marginBottom: "12px" }}>
                <div>
                  <div style={{ fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.12em", color: "#98a2b3", fontWeight: 700 }}>{getWeekdayLabel(entry.date)}</div>
                  <div style={{ fontSize: "18px", fontWeight: 700 }}>{formatDateGerman(entry.date)}</div>
                </div>
                <span style={styles.badgeNeutral}>{entry.jobs.length} Einsatz{entry.jobs.length === 1 ? "" : "e"}</span>
              </div>
                  ...
                  <div key={job.id} style={styles.calendarJobItem}>
                    <div style={{ display: "flex", justifyContent: "space-between", gap: "10px", alignItems: "flex-start" }}>
                      <div>
                        ...
                        <div style={{ color: "#667085", fontSize: "13px", marginTop: "3px" }}>{getPropertyDisplayName(job.property_id)}</div>
                      </div>
      ...
      <section style={styles.card}>
        <div style={styles.heroBox}>
          <div style={{ fontSize: "12px", opacity: 0.82, marginBottom: "10px", textTransform: "uppercase", letterSpacing: "0.12em", fontWeight: 700 }}>Aufträge & Einsatzplanung</div>
          <div style={{ fontSize: "34px", fontWeight: 800, lineHeight: 1.02, letterSpacing: "-0.04em" }}>Auftrag anlegen</div>
          <div style={{ marginTop: "10px", color: "rgba(255,255,255,0.78)", fontSize: "14px", lineHeight: 1.7, maxWidth: "560px" }}>Plane operative Einsätze, setze Prioritäten und dokumentiere sauber, was vor Ort erledigt wurde.</div>
        </div>
        <div style={styles.stack}>
          <div style={styles.row}>
            <div style={{ flex: 1 }}>
            ...
            {jobs.map((job) => {
              ...
              return (
                <div key={job.id} style={styles.entityCard}>
                  <div style={styles.entityHeader}>
                    <div>
                      <h3 style={{ margin: "0 0 6px 0", fontSize: "22px" }}>{job.title}</h3>
  ...
  const renderLeads = () => (
    <div style={styles.layoutTwoCol}>
      <section style={styles.card}>
        <div style={styles.heroBox}>
          <div style={{ fontSize: "12px", opacity: 0.82, marginBottom: "10px", textTransform: "uppercase", letterSpacing: "0.12em", fontWeight: 700 }}>Anfragen & Website-Leads</div>
          <div style={{ fontSize: "34px", fontWeight: 800, lineHeight: 1.02, letterSpacing: "-0.04em" }}>Lead erfassen</div>
          <div style={{ marginTop: "10px", color: "rgba(255,255,255,0.78)", fontSize: "14px", lineHeight: 1.7, maxWidth: "560px" }}>Spiegele Website-Anfragen direkt in dein System, qualifiziere sie und überführe sie ohne Medienbruch in Kunden und Objekte.</div>
        </div>
        <div style={styles.stack}>
          <div style={styles.row}>
            <div style={{ width: "180px" }}>
          ...
          <div style={styles.mutedBox}>
            <strong>Website-Verbindung</strong>
            <div style={{ marginTop: "8px", color: "#475467", lineHeight: 1.7 }}>Dein Website-Formular kann im nächsten Schritt direkt auf dieselbe Struktur schreiben. Dann landen neue Anfragen sofort hier als Leads und können ohne Copy/Paste weiterqualifiziert werden.</div>
          </div>
        </div>
      </section>
      ...
      <section style={styles.card}>
        ...
        {leads.length === 0 ? <p>Noch keine Leads vorhanden.</p> : (
          <div style={styles.bigList}>
            {leads.map((lead) => (
              <div key={lead.id} style={styles.entityCard}>
                <div style={styles.entityHeader}>
                  <div>
                    <h3 style={{ margin: "0 0 6px 0", fontSize: "22px" }}>{lead.company || lead.name}</h3>
                    <div style={{ color: "#4b5563", fontSize: "14px" }}>{lead.name} · {lead.email}</div>
                    <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginTop: "10px" }}>
                      <span style={styles.badgeNeutral}>{lead.source}</span>
                      <span style={lead.status === "won" ? styles.badgePaid : lead.status === "lost" ? styles.badgeOpen : styles.badgeNeutral}>{getLeadStatusLabel(lead.status)}</span>
                      {lead.property_type ? <span style={styles.badgeNeutral}>{lead.property_type}</span> : null}
                    </div>
                  </div>
                  <div style={{ ...styles.row, justifyContent: "flex-end" }}>
                    <ActionButton onClick={() => advanceLeadStatus(lead.id, "qualified")} style={styles.buttonSecondary}>Qualifizieren</ActionButton>
                    <ActionButton onClick={() => advanceLeadStatus(lead.id, "offered")} style={styles.buttonSecondary}>Angebot gesendet</ActionButton>
                    <ActionButton onClick={() => { setCustomerForm({ companyName: lead.company || lead.name, contactPerson: lead.name, email: lead.email, phone: lead.phone, street: "", zip: "", city: lead.location }); setActiveTab("customers"); }} style={styles.buttonGhost}>Kunde vorbereiten</ActionButton>
                    <ActionButton onClick={() => convertLeadToCustomerAndProperty(lead)} style={styles.buttonPrimary}>In Kunde überführen</ActionButton>
                  </div>
                </div>
                <div style={{ ...styles.mutedBox, marginTop: "14px", color: "#475467", lineHeight: 1.7 }}>{lead.notes || "Keine zusätzliche Beschreibung vorhanden."}</div>
              </div>
            ))}
          </div>
        )}
        ...
        <div style={styles.header}>
          <div>
            ...
            <p style={styles.subtitle}>
              Angebote, Rechnungen, Finanzen, Entwürfe und Backups in einer klaren, professionellen Oberfläche mit lokaler Sicherheitskopie.
            </p>
